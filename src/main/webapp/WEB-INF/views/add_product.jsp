...
<head>
    ...
    <style>
        body {
            ...
            background: linear-gradient(to right, #c6ffdd, #fbd786, #f7797d); /* ombre gradient */
            min-height: 100vh;
            display: flex;
        ...
        .btn-gradient:hover {
            transform: scale(1.05);
            box-shadow: 0 0 16px rgba(255, 75, 43, 0.8);
        }
    </style>
</head>
